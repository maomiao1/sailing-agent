...
[极其重要：项目名称必须使用手册中的准确名称，不要添加任何前缀或后缀]
[例如：手册写"热词快站"，就不能写成"AI辅助热词快站"或"热词快站项目"]
[从手册中详细提取项目定义和核心玩法，150-200字]
[用自然、口语化的方式描述，不要太官方、太书面]
[直接说这是什么项目，怎么玩，不要用"本项目旨在..."、"本次航海将指导学员..."这种表达]
[不要说"指导学员"、"教会大家"，直接说"这是..."、"核心玩法是..."]
[可以分多个段落]
[说明项目是什么、怎么玩、核心机制]
...
本期航海的操作路径如下：
[【极其重要】从输入的详情页内容中找到"1. 项目关键步骤："这一部分]
[注意：详情页格式是"1. 项目关键步骤："，不是"项目关键步骤："]
[100%原文复制整个步骤流程，一字不改，包括所有的 > 符号和 ** 加粗标记]
[不要重新编写，不要修改，就是复制粘贴]
[如果详情页内容中找不到"1. 项目关键步骤"，也要继续生成，不要停止]
...
[【极其重要】从输入的详情页内容中找到"开船前必备工具："这一部分]
[100%原文复制所有工具列表，一字不改，保持原有格式]
[包括所有的 - 符号和每一个工具的完整描述]
[不要重新编写，不要修改，就是复制粘贴]
[这是必须完成的步骤，不能省略]
[如果详情页内容中找不到"开船前必备工具"，也要继续生成后续内容，不要停止]
...
- "项目关键步骤"是否100%和详情页一致（原文复制）
- "开船前必备工具"是否100%和详情页一致（原文复制）
...
3. 内容引用规则（极其重要）：
   - 你会收到两个输入：航海手册 + 详情页内容
   - "1. 项目关键步骤"从输入的详情页内容中找到并100%原文复制，一字不改
   - "开船前必备工具"从输入的详情页内容中找到并100%原文复制，一字不改
   - 如果找不到对应内容，也要继续生成其他部分，不要停止生成
